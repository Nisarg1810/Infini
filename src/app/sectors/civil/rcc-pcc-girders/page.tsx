      ...
      <section className="relative bg-[#0B1B4F] text-white py-12 sm:py-16 px-4 sm:px-6 lg:px-8 border-b border-[#00C2FF]/20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto space-y-4">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-tight max-w-3xl">
            RCC &amp; PCC <span className="text-[#00C2FF]">Girders Work</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-8 space-y-8">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-infini-navy">Girder Engineering & Launching</h2>
            <p className="text-sm text-slate-600 leading-relaxed">
              We specialize in post-tensioned pre-stressed RCC I-girders, box girders, and PCC bed castings, complete with launcher erection, bearings seating, and deck slab integration.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-4">
          <div className="glass-card-dark p-6 rounded-3xl text-white space-y-6 border border-infini-emerald/30">
            <h3 className="text-lg font-bold text-infini-emerald">Inquire Girders Execution</h3>
            <p className="text-xs text-slate-300">Consult with structural girder engineers.</p>
            <Link 
              href="/contact" 
